...
`define FAN_FM  `C+13
`define FAN_EN_FM  `E+2

`define IN1_ISO_FM  `D+8
`define IN2_ISO_FM  `E+9
`define IN3_ISO_FM  `E+11
`define OUT1_ISO_FM  `C+12
`define OUT2_ISO_FM  `C+11
`define OUT3_ISO_FM  `E+12 
`define OUT4_ISO_FM  `D+12 
`define OUT5_ISO_FM  `E+13 
`define OUT6_ISO_FM  `D+13 

`define IO1_FM  `K+4 
`define IO2_FM  `F+2 
`define IO3_FM  `E+1 

`define UNI_IO1_FM  `C+10 
`define UNI_IO2_FM  `E+8 
`define UNI_IO3_FM  `A+14 
`define UNI_IO4_FM  `E+7 

`define LED_SFP1_TX_FM  `A+18 
`define LED_SFP1_RX_FM  `B+17 
`define LED_SFP2_TX_FM  `A+17 
`define LED_SFP2_RX_FM  `B+16 
